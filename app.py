...
def calcular_valor_intrinseco(row, taxa_desconto):
    ...
    # Limita g de forma muito mais conservadora do que "r - 1%": um spread tão
    # pequeno faz o denominador (r - g) aproximar-se de zero, o que faz o valor
    # calculado "explodir" matematicamente — não porque a ação valha mesmo isso,
    # mas por instabilidade da fórmula quando g se aproxima de r. É uma armadilha
    # clássica e conhecida deste modelo. Aplicamos dois limites, o mais apertado
    # dos dois vence:
    #   1) teto absoluto de 5% — nenhuma empresa cresce o dividendo mais depressa
    #      que a economia global, de forma sustentável, para sempre;
    #   2) spread mínimo de 3 pontos percentuais face à taxa de retorno exigida.
...
- A taxa de crescimento usada é a **CAGR histórica dos últimos 5 anos**, mas é sempre limitada a um máximo de **5%** e a pelo menos **3 pontos percentuais abaixo** da taxa de retorno exigida — sem este limite, o modelo "explode" matematicamente sempre que o crescimento se aproxima da taxa de retorno (uma armadilha clássica e conhecida deste tipo de modelo).
